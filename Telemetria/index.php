...
<body> 
    <nav class="navbar navbar-expand-lg" id="main_navbar">
        ...
        <img src="img/logo.png" width="35px" height="35px" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="sir.png">
            <a class="p-0 nav-link font-italic font-weight-bold text-light" href="#" title="Corporativo Grupo Ríos S.A de C.V" style="font-size: 18px;">
               Corporativo Grupo Ríos</a>
        <!--button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <i class="fas fa-water text-light"></i>
        </button>
            ...
            <ul class="navbar-nav mr-auto" id="ulMenu">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fas fa-sitemap text-right"></i> Inicio
                    </a>
                    <ul class="dropdown-menu triangulo_fijo" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="index.php">Inico <i class="fas fa-home"></i></a></li>
                    </ul>
                </li>

                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle Ventas" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fas fa-file-invoice-dollar"></i> Graficas
                    </a>
                    <class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="graficas.php">Graficas <i class="fas fa-chart-area"></i></a></li>
                    </ul>
                </li>
            </ul>
